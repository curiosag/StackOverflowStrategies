(function () {
    ...
    function d(g, A) {
        "use strict";
        var C = A ? "Error in " + A + " extension->" : "Error in unnamed extension", I = {valid: !0, error: ""};
        m.helper.isArray(g) || (g = [g]);
        for (var e = 0; e < g.length; ++e) {
            var r = C + " sub-extension " + e + ": ", t = g[e];
            if ("object" != typeof t) return I.valid = !1, I.error = r + "must be an object, but " + typeof t + " given", I;
            if (!m.helper.isString(t.type)) return I.valid = !1, I.error = r + 'property "type" must be a string, but ' + typeof t.type + " given", I;
            var a = t.type = t.type.toLowerCase();
            if ("language" === a && (a = t.type = "lang"), "html" === a && (a = t.type = "output"), "lang" !== a && "output" !== a && "listener" !== a) return I.valid = !1, I.error = r + "type " + a + ' is not recognized. Valid values: "lang/language", "output/html" or "listener"', I;
            if ("listener" === a) {
                if (m.helper.isUndefined(t.listeners)) return I.valid = !1, I.error = r + '. Extensions of type "listener" must have a property called "listeners"', I
            } else if (m.helper.isUndefined(t.filter) && m.helper.isUndefined(t.regex)) return I.valid = !1, I.error = r + a + ' extensions must define either a "regex" property or a "filter" method', I;
            if (t.listeners) {
                ...
                for (var n in t.listeners) if (t.listeners.hasOwnProperty(n) && "function" != typeof t.listeners[n]) return I.valid = !1, I.error = r + '"listeners" property must be an hash of [event name]: [callback]. listeners.' + n + " must be a function but " + typeof t.listeners[n] + " given", I
            }
            if (t.filter) {
                if ("function" != typeof t.filter) return I.valid = !1, I.error = r + '"filter" must be a function, but ' + typeof t.filter + " given", I
            } else if (t.regex) {
                if (m.helper.isString(t.regex) && (t.regex = new RegExp(t.regex, "g")), !(t.regex instanceof RegExp)) return I.valid = !1, I.error = r + '"regex" property must either be a string or a RegExp object, but ' + typeof t.regex + " given", I;
                if (m.helper.isUndefined(t.replace)) return I.valid = !1, I.error = r + '"regex" extensions must implement a replace string or function', I
            }
        }
        return I
    }
    ...
    m.helper = {}, m.extensions = {}, m.setOption = function (g, A) {
        ...
        if (g = m.helper.stdExtName(g), m.helper.isUndefined(A)) {
            if (!i.hasOwnProperty(g)) throw Error("Extension named " + g + " is not registered!");
            return i[g]
        }
        ...
        if ("function" == typeof g.forEach) g.forEach(A); else if (m.helper.isArray(g)) for (var C = 0; C < g.length; C++) A(g[C], C, g); else {
    ...
    function p(g, A, C, I) {
        "use strict";
        var e, r, t, a, n, o = I || "", s = -1 < o.indexOf("g"), i = new RegExp(A + "|" + C, "g" + o.replace(/g/g, "")),
    ...
    m.helper.matchRecursiveRegExp = function (g, A, C, I) {
        "use strict";
        for (var e = p(g, A, C, I), r = [], t = 0; t < e.length; ++t) r.push([g.slice(e[t].wholeMatch.start, e[t].wholeMatch.end), g.slice(e[t].match.start, e[t].match.end), g.slice(e[t].left.start, e[t].left.end), g.slice(e[t].right.start, e[t].right.end)]);
        return r
        ...
        var t = p(g, C, I, e), a = g, n = t.length;
        if (0 < n) {
            var o = [];
            0 !== t[0].wholeMatch.start && o.push(g.slice(0, t[0].wholeMatch.start));
            for (var s = 0; s < n; ++s) o.push(A(g.slice(t[s].wholeMatch.start, t[s].wholeMatch.end), g.slice(t[s].match.start, t[s].match.end), g.slice(t[s].left.start, t[s].left.end), g.slice(t[s].right.start, t[s].right.end))), s < n - 1 && o.push(g.slice(t[s].wholeMatch.end, t[s + 1].wholeMatch.start));
        ...
        "use strict";
        var I = {}, r = [], t = [], a = {}, e = c, n = {parsed: {}, raw: "", format: ""};

        function o(g, A) {
            if (A = A || null, m.helper.isString(g)) {
                if (A = g = m.helper.stdExtName(g), m.extensions[g]) return console.warn("DEPRECATION WARNING: " + g + " is an old extension that uses a deprecated loading method.Please inform the developer that the extension should be updated!"), void function (g, A) {
                ...
                if (m.helper.isUndefined(i[g])) throw Error('Extension "' + g + '" could not be loaded. It was either not found or is not a valid extension.');
                g = i[g]
            }
            ...
            for (var I = 0; I < g.length; ++I) {
                ...
                if (g[I].hasOwnProperty("listeners")) for (var e in g[I].listeners) g[I].listeners.hasOwnProperty(e) && s(e, g[I].listeners[e])
            }
        }
        ...
        function s(g, A) {
            ...
            a.hasOwnProperty(g) || (a[g] = []), a[g].push(A)
        }

        !function () {
            for (var g in C = C || {}, l) l.hasOwnProperty(g) && (I[g] = l[g]);
            {
            ...
            I.extensions && m.helper.forEach(I.extensions, o)
        }(), this._dispatch = function (g, A, C, I) {
            if (a.hasOwnProperty(g)) for (var e = 0; e < a[g].length; ++e) {
                var r = a[g][e](g, A, this, C, I);
                r && void 0 !== r && (A = r)
            }
            return A
            ...
            return A = (A = (A = (A = (A = A.replace(/\xa8/g, "\xa8T")).replace(/\$/g, "\xa8D")).replace(/\r\n/g, "\n")).replace(/\r/g, "\n")).replace(/\u00A0/g, " "), I.smartIndentationFix && (A = function (g) {
                var A = g.match(/^\s*/)[0].length, C = new RegExp("^\\s{0," + A + "}", "gm");
                return g.replace(C, "")
            }(A)), A = "\n\n" + A + "\n\n", A = (A = m.subParser("detab")(A, I, C)).replace(/^[ \t]+$/gm, ""), m.helper.forEach(r, function (g) {
                A = m.subParser("runExtension")(g, A, I, C)
            }), A = m.subParser("metadata")(A, I, C), A = m.subParser("hashPreCodeTags")(A, I, C), A = m.subParser("githubCodeBlocks")(A, I, C), A = m.subParser("hashHTMLBlocks")(A, I, C), A = m.subParser("hashCodeTags")(A, I, C), A = m.subParser("stripLinkDefinitions")(A, I, C), A = m.subParser("blockGamut")(A, I, C), A = m.subParser("unhashHTMLSpans")(A, I, C), A = (A = (A = m.subParser("unescapeSpecialChars")(A, I, C)).replace(/\xa8D/g, "$$")).replace(/\xa8T/g, "\xa8"), A = m.subParser("completeHTMLDocument")(A, I, C), m.helper.forEach(t, function (g) {
                A = m.subParser("runExtension")(g, A, I, C)
            }), n = C.metadata, A
            ...
            if (!u.hasOwnProperty(g)) throw Error(g + " flavor was not found");
            var A = u[g];
            for (var C in e = g, A) A.hasOwnProperty(C) && (I[C] = A[C])
        }, this.getFlavor = function () {
            return e
        }, this.removeExtension = function (g) {
            m.helper.isArray(g) || (g = [g]);
            for (var A = 0; A < g.length; ++A) {
                for (var C = g[A], I = 0; I < r.length; ++I) r[I] === C && r[I].splice(I, 1);
                for (; 0 < t.length; ++I) t[0] === C && t[0].splice(I, 1)
            }
        }, this.getAllExtensions = function () {
            return {language: r, output: t}
        }, this.getMetadata = function (g) {
            return g ? n.raw : n.parsed
        ...
        function A(g, A, C, I, e, r, t) {
            if (m.helper.isUndefined(t) && (t = ""), C = C.toLowerCase(), -1 < g.search(/\(<?\s*>? ?(['"].*['"])?\)$/m)) I = ""; else if (!I) {
                if (I = "#" + (C = C || A.toLowerCase().replace(/ ?\n/g, " ")), m.helper.isUndefined(o.gUrls[C])) return g;
            ...
            return "" !== t && null !== t && (a += ' title="' + (t = (t = t.replace(/"/g, "&quot;")).replace(m.helper.regexes.asteriskDashAndColon, m.helper.escapeCharactersCallback)) + '"'), n.openLinksInNewWindow && !/^#/.test(I) && (a += ' target="\xa8E95Eblank"'), a += ">" + A + "</a>"
        }
        ...
        return g = (g = (g = (g = (g = o.converter._dispatch("anchors.before", g, n, o)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)] ?(?:\n *)?\[(.*?)]()()()()/g, A)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<([^>]*)>(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, A)).replace(/\[((?:\[[^\]]*]|[^\[\]])*)]()[ \t]*\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?:[ \t]*((["'])([^"]*?)\5))?[ \t]?\)/g, A)).replace(/\[([^\[\]]+)]()()()()()/g, A), n.ghMentions && (g = g.replace(/(^|\s)(\\)?(@([a-z\d\-]+))(?=[.!?;,[\]()]|\s|$)/gim, function (g, A, C, I, e) {
            ...
            return n.openLinksInNewWindow && (t = ' target="\xa8E95Eblank"'), A + '<a href="' + r + '"' + t + ">" + I + "</a>"
    ...
    function e(l) {
        ...
        return function (g, A, C, I, e, r, t) {
            var a = C = C.replace(m.helper.regexes.asteriskDashAndColon, m.helper.escapeCharactersCallback), n = "",
                o = "", s = A || "", i = t || "";
            return /^www\./i.test(C) && (C = C.replace(/^www\./i, "http://www.")), l.excludeTrailingPunctuationFromURLs && r && (n = r), l.openLinksInNewWindow && (o = ' target="\xa8E95Eblank"'), s + '<a href="' + C + '"' + o + ">" + a + "</a>" + n + i
        }
    }
    ...
    var a = /([*~_]+|\b)(((https?|ftp|dict):\/\/|www\.)[^'">\s]+?\.[^'">\s]+?)()(\1)?(?=\s|$)(?!["<>])/gi,
        ...
        s = /(^|\s)(?:mailto:)?([A-Za-z0-9!#$%&'*+-/=?^_`{|}~.]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)(?=$|\s)/gim,
        h = /<()(?:mailto:)?([-.\w]+@[-a-z0-9]+(\.[-a-z0-9]+)*\.[a-z]+)>/gi;
    m.subParser("autoLinks", function (g, A, C) {
        "use strict";
        return g = (g = (g = C.converter._dispatch("autoLinks.before", g, A, C)).replace(o, e(A))).replace(h, t(A, C)), g = C.converter._dispatch("autoLinks.after", g, A, C)
    }), m.subParser("simplifiedAutoLinks", function (g, A, C) {
        "use strict";
        return A.simplifiedAutoLink ? (g = C.converter._dispatch("simplifiedAutoLinks.before", g, A, C), g = (g = A.excludeTrailingPunctuationFromURLs ? g.replace(n, e(A)) : g.replace(a, e(A))).replace(s, t(A, C)), g = C.converter._dispatch("simplifiedAutoLinks.after", g, A, C)) : g
    }), m.subParser("blockGamut", function (g, A, C) {
        "use strict";
        return g = C.converter._dispatch("blockGamut.before", g, A, C), g = m.subParser("blockQuotes")(g, A, C), g = m.subParser("headers")(g, A, C), g = m.subParser("horizontalRule")(g, A, C), g = m.subParser("lists")(g, A, C), g = m.subParser("codeBlocks")(g, A, C), g = m.subParser("tables")(g, A, C), g = m.subParser("hashHTMLBlocks")(g, A, C), g = m.subParser("paragraphs")(g, A, C), g = C.converter._dispatch("blockGamut.after", g, A, C)
        ...
        return A.splitAdjacentBlockquotes && (I = /^ {0,3}>[\s\S]*?(?:\n\n)/gm), g = g.replace(I, function (g) {
            return g = (g = (g = g.replace(/^[ \t]*>[ \t]?/gm, "")).replace(/\xa80/g, "")).replace(/^[ \t]+$/gm, ""), g = m.subParser("githubCodeBlocks")(g, A, C), g = (g = (g = m.subParser("blockGamut")(g, A, C)).replace(/(^|\n)/g, "$1  ")).replace(/(\s*<pre>[^\r]+?<\/pre>)/gm, function (g, A) {
                var C = A;
                return C = (C = C.replace(/^  /gm, "\xa80")).replace(/\xa80/g, "")
        ...
        })).replace(/\xa80/, ""), g = a.converter._dispatch("codeBlocks.after", g, t, a)
        ...
        return void 0 === (g = t.converter._dispatch("codeSpans.before", g, r, t)) && (g = ""), g = g.replace(/(^|[^\\])(`+)([^\r]*?[^`])\2(?!`)/gm, function (g, A, C, I) {
            var e = I;
            return e = (e = e.replace(/^([ \t]*)/g, "")).replace(/[ \t]*$/g, ""), e = A + "<code>" + (e = m.subParser("encodeCode")(e, r, t)) + "</code>", e = m.subParser("hashHTMLSpans")(e, r, t)
        ...
        "use strict";
        return g = (g = (g = C.converter._dispatch("encodeBackslashEscapes.before", g, A, C)).replace(/\\(\\)/g, m.helper.escapeCharactersCallback)).replace(/\\([`*_{}\[\]()>#+.!~=|-])/g, m.helper.escapeCharactersCallback), g = C.converter._dispatch("encodeBackslashEscapes.after", g, A, C)
    }), m.subParser("encodeCode", function (g, A, C) {
        "use strict";
        return g = (g = C.converter._dispatch("encodeCode.before", g, A, C)).replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/([*_{}\[\]\\=~-])/g, m.helper.escapeCharactersCallback), g = C.converter._dispatch("encodeCode.after", g, A, C)
        ...
        return g = m.helper.replaceRecursiveRegExp(g, function (g, A, C, I) {
            var e = C + m.subParser("encodeCode")(A, r, t) + I;
            return "\xa8C" + (t.gHtmlSpans.push(e) - 1) + "C"
        }, "<code\\b[^>]*>", "</code>", "gim"), g = t.converter._dispatch("hashCodeTags.after", g, r, t)
        ...
        for (var e = 0; e < I.length; ++e) for (var t, a = new RegExp("^ {0,3}(<" + I[e] + "\\b[^>]*>)", "im"), n = "<" + I[e] + "\\b[^>]*>", o = "</" + I[e] + ">"; -1 !== (t = m.helper.regexIndexOf(g, a));) {
            var s = m.helper.splitAtIndex(g, t), i = m.helper.replaceRecursiveRegExp(s[1], C, n, o, "im");
            if (i === s[1]) break;
            g = s[0].concat(i)
        }
        return g = g.replace(/(\n {0,3}(<(hr)\b([^<>])*?\/?>)[ \t]*(?=\n{2,}))/g, m.subParser("hashElement")(g, A, r)), g = (g = m.helper.replaceRecursiveRegExp(g, function (g) {
            return "\n\n\xa8K" + (r.gHtmlBlocks.push(g) - 1) + "K\n\n"
        }, "^ {0,3}\x3c!--", "--\x3e", "gm")).replace(/(?:\n\n)( {0,3}(?:<([?%])[^\r]*?\2>)[ \t]*(?=\n{2,}))/g, m.subParser("hashElement")(g, A, r)), g = r.converter._dispatch("hashHTMLBlocks.after", g, A, r)
        ...
        return g = m.helper.replaceRecursiveRegExp(g, function (g, A, C, I) {
            var e = C + m.subParser("encodeCode")(A, r, t) + I;
            return "\n\n\xa8G" + (t.ghCodeBlocks.push({text: g, codeblock: e}) - 1) + "G\n\n"
        }, "^ {0,3}<pre\\b[^>]*>\\s*<code\\b[^>]*>", "^ {0,3}</code>\\s*</pre>", "gim"), g = t.converter._dispatch("hashPreCodeTags.after", g, r, t)
    }), m.subParser("headers", function (g, n, o) {
        "use strict";
        g = o.converter._dispatch("headers.before", g, n, o);
        var s = isNaN(parseInt(n.headerLevelStart)) ? 1 : parseInt(n.headerLevelStart),
            A = n.smoothLivePreview ? /^(.+)[ \t]*\n={2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n=+[ \t]*\n+/gm,
            C = n.smoothLivePreview ? /^(.+)[ \t]*\n-{2,}[ \t]*\n+/gm : /^(.+)[ \t]*\n-+[ \t]*\n+/gm;
        g = (g = g.replace(A, function (g, A) {
            var C = m.subParser("spanGamut")(A, n, o), I = n.noHeaderId ? "" : ' id="' + i(A) + '"',
                e = "<h" + s + I + ">" + C + "</h" + s + ">";
            return m.subParser("hashBlock")(e, n, o)
        })).replace(C, function (g, A) {
            var C = m.subParser("spanGamut")(A, n, o), I = n.noHeaderId ? "" : ' id="' + i(A) + '"', e = s + 1,
                r = "<h" + e + I + ">" + C + "</h" + e + ">";
            return m.subParser("hashBlock")(r, n, o)
        });
        var I = n.requireSpaceBeforeHeadingText ? /^(#{1,6})[ \t]+(.+?)[ \t]*#*\n+/gm : /^(#{1,6})[ \t]*(.+?)[ \t]*#*\n+/gm;
        ...
        function i(g) {
            ...
            return A = g, C = m.helper.isString(n.prefixHeaderId) ? n.prefixHeaderId : !0 === n.prefixHeaderId ? "section-" : "", n.rawPrefixHeaderId || (A = C + A), A = n.ghCompatibleHeaderId ? A.replace(/ /g, "-").replace(/&amp;/g, "").replace(/\xa8T/g, "").replace(/\xa8D/g, "").replace(/[&+$,\/:;=?@"#{}|^\xa8~\[\]`\\*)(%.!'<>]/g, "").toLowerCase() : n.rawHeaderId ? A.replace(/ /g, "-").replace(/&amp;/g, "&").replace(/\xa8T/g, "\xa8").replace(/\xa8D/g, "$").replace(/["']/g, "-").toLowerCase() : A.replace(/[^\w]/g, "").toLowerCase(), n.rawPrefixHeaderId && (A = C + A), o.hashLinkCounts[A] ? A = A + "-" + o.hashLinkCounts[A]++ : o.hashLinkCounts[A] = 1, A
        }

        return g = g.replace(I, function (g, A, C) {
            var I = C;
            n.customizedHeaderId && (I = C.replace(/\s?\{([^{]+?)}\s*$/, ""));
            var e = m.subParser("spanGamut")(I, n, o), r = n.noHeaderId ? "" : ' id="' + i(C) + '"',
                t = s - 1 + A.length, a = "<h" + t + r + ">" + e + "</h" + t + ">";
        ...
        function n(g, A, C, I, e, r, t, a) {
            var n = l.gUrls, o = l.gTitles, s = l.gDimensions;
            if (C = C.toLowerCase(), a = a || "", -1 < g.search(/\(<?\s*>? ?(['"].*['"])?\)$/m)) I = ""; else if ("" === I || null === I) {
                if ("" !== C && null !== C || (C = A.toLowerCase().replace(/ ?\n/g, " ")), I = "#" + C, m.helper.isUndefined(n[C])) return g;
                I = n[C], m.helper.isUndefined(o[C]) || (a = o[C]), m.helper.isUndefined(s[C]) || (e = s[C].width, r = s[C].height)
            }
            A = A.replace(/"/g, "&quot;").replace(m.helper.regexes.asteriskDashAndColon, m.helper.escapeCharactersCallback);
            var i = '<img src="' + (I = I.replace(m.helper.regexes.asteriskDashAndColon, m.helper.escapeCharactersCallback)) + '" alt="' + A + '"';
            return a && (i += ' title="' + (a = a.replace(/"/g, "&quot;").replace(m.helper.regexes.asteriskDashAndColon, m.helper.escapeCharactersCallback)) + '"'), e && r && (i += ' width="' + (e = "*" === e ? "auto" : e) + '"', i += ' height="' + (r = "*" === r ? "auto" : r) + '"'), i += " />"
        }
        ...
        return g = (g = (g = (g = (g = (g = l.converter._dispatch("images.before", g, A, l)).replace(/!\[([^\]]*?)] ?(?:\n *)?\[([\s\S]*?)]()()()()()/g, n)).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<?(data:.+?\/.+?;base64,[A-Za-z0-9+/=\n]+?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g, function (g, A, C, I, e, r, t, a) {
            return n(g, A, C, I = I.replace(/\s/g, ""), e, r, t, a)
        })).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<([^>]*)>(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(?:(["'])([^"]*?)\6))?[ \t]?\)/g, n)).replace(/!\[([^\]]*?)][ \t]*()\([ \t]?<?([\S]+?(?:\([\S]*?\)[\S]*?)?)>?(?: =([*\d]+[A-Za-z%]{0,4})x([*\d]+[A-Za-z%]{0,4}))?[ \t]*(?:(["'])([^"]*?)\6)?[ \t]?\)/g, n)).replace(/!\[([^\[\]]+)]()()()()()/g, n), g = l.converter._dispatch("images.after", g, A, l)
        ...
        function l(g, A) {
            ...
            return i.disableForced4SpacesIndentedSublists && (C = /(\n)?(^ {0,3})([*+-]|\d+[.])[ \t]+((\[(x|X| )?])?[ \t]*[^\r]+?(\n{1,2}))(?=\n*(\xa80|\2([*+-]|\d+[.])[ \t]+))/gm), g = (g = g.replace(C, function (g, A, C, I, e, r, t) {
                ...
                return r && i.tasklists && (n = ' class="task-list-item" style="list-style-type: none;"', a = a.replace(/^[ \t]*\[(x|X| )?]/m, function () {
                    ...
                    return "\xa8A" + g
                }), a = "<li" + n + ">" + (a = (a = A || -1 < a.search(/\n{2,}/) ? (a = m.subParser("githubCodeBlocks")(a, i, s), m.subParser("blockGamut")(a, i, s)) : (a = (a = m.subParser("lists")(a, i, s)).replace(/\n$/, ""), a = (a = m.subParser("hashHTMLBlocks")(a, i, s)).replace(/\n\n+/g, "\n\n"), o ? m.subParser("paragraphs")(a, i, s) : m.subParser("spanGamut")(a, i, s))).replace("\xa8A", "")) + "</li>\n"
            })).replace(/\xa80/g, ""), s.gListLevel--, A && (g = g.replace(/\s+$/, "")), g
        }
        ...
        function e(e, r, t) {
            var a = i.disableForced4SpacesIndentedSublists ? /^ ?\d+\.[ \t]/gm : /^ {0,3}\d+\.[ \t]/gm,
                n = i.disableForced4SpacesIndentedSublists ? /^ ?[*+-][ \t]/gm : /^ {0,3}[*+-][ \t]/gm,
                o = "ul" === r ? a : n, s = "";
            if (-1 !== e.search(o)) !function g(A) {
        ...
        return g = s.converter._dispatch("lists.before", g, i, s), g += "\xa80", g = (g = s.gListLevel ? g.replace(/^(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(\xa80|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function (g, A, C) {
            return e(A, -1 < C.search(/[*+-]/g) ? "ul" : "ol", !0)
        }) : g.replace(/(\n\n|^\n?)(( {0,3}([*+-]|\d+[.])[ \t]+)[^\r]+?(\xa80|\n{2,}(?=\S)(?![ \t]*(?:[*+-]|\d+[.])[ \t]+)))/gm, function (g, A, C, I) {
            return e(C, -1 < I.search(/[*+-]/g) ? "ul" : "ol", !1)
        })).replace(/\xa80/, ""), g = s.converter._dispatch("lists.after", g, i, s)
        ...
        return g = (g = (g = (g = I.converter._dispatch("metadata.before", g, A, I)).replace(/^\s*\xab\xab\xab+(\S*?)\n([\s\S]+?)\n\xbb\xbb\xbb+\n/, function (g, A, C) {
            return e(C), "\xa8M"
        })).replace(/^\s*---+(\S*?)\n([\s\S]+?)\n---+\n/, function (g, A, C) {
            return A && (I.metadata.format = A), e(C), "\xa8M"
        })).replace(/\xa8M/g, ""), g = I.converter._dispatch("metadata.after", g, A, I)
        ...
        for (var I = (g = (g = (g = C.converter._dispatch("paragraphs.before", g, A, C)).replace(/^\n+/g, "")).replace(/\n+$/g, "")).split(/\n{2,}/g), e = [], r = I.length, t = 0; t < r; t++) {
            var a = I[t];
            0 <= a.search(/\xa8(K|G)(\d+)\1/g) ? e.push(a) : 0 <= a.search(/\S/) && (a = (a = m.subParser("spanGamut")(a, A, C)).replace(/^([ \t]*)/g, "<p>"), a += "</p>", e.push(a))
        }
        for (r = e.length, t = 0; t < r; t++) {
            for (var n = "", o = e[t], s = !1; /\xa8(K|G)(\d+)\1/.test(o);) {
                var i = RegExp.$1, l = RegExp.$2;
                n = (n = "K" === i ? C.gHtmlBlocks[l] : s ? m.subParser("encodeCode")(C.ghCodeBlocks[l].text, A, C) : C.ghCodeBlocks[l].codeblock).replace(/\$/g, "$$$$"), o = o.replace(/(\n\n)?\xa8(K|G)\d+\2(\n\n)?/, n), /^<pre\b[^>]*>\s*<code\b[^>]*>/.test(o) && (s = !0)
            }
            e[t] = o
        }
    ...
    }), m.subParser("strikethrough", function (g, C, I) {
        "use strict";
        return C.strikethrough && (g = (g = I.converter._dispatch("strikethrough.before", g, C, I)).replace(/(?:~){2}([\s\S]+?)(?:~){2}/g, function (g, A) {
            return function (g) {
                return C.simplifiedAutoLink && (g = m.subParser("simplifiedAutoLinks")(g, C, I)), "<del>" + g + "</del>"
            }(A)
        ...
        function A(g) {
            var A, C = g.split("\n");
            for (A = 0; A < C.length; ++A) /^ {0,3}\|/.test(C[A]) && (C[A] = C[A].replace(/^ {0,3}\|/, "")), /\|[ \t]*$/.test(C[A]) && (C[A] = C[A].replace(/\|[ \t]*$/, "")), C[A] = m.subParser("codeSpans")(C[A], p, h);
            var I, e, r, t, a, n = C[0].split("|").map(function (g) {
                return g.trim()
            ...
            for (A = 0; A < o.length; ++A) l.push((I = o[A], /^:[ \t]*--*$/.test(I) ? ' style="text-align:left;"' : /^--*[ \t]*:[ \t]*$/.test(I) ? ' style="text-align:right;"' : /^:[ \t]*--*[ \t]*:$/.test(I) ? ' style="text-align:center;"' : ""));
            for (A = 0; A < n.length; ++A) m.helper.isUndefined(l[A]) && (l[A] = ""), i.push((e = n[A], r = l[A], t = void 0, t = "", e = e.trim(), (p.tablesHeaderId || p.tableHeaderId) && (t = ' id="' + e.replace(/ /g, "_").toLowerCase() + '"'), "<th" + t + r + ">" + (e = m.subParser("spanGamut")(e, p, h)) + "</th>\n"));
            for (A = 0; A < s.length; ++A) {
                for (var u = [], d = 0; d < i.length; ++d) m.helper.isUndefined(s[A][d]), u.push((a = s[A][d], "<td" + l[d] + ">" + m.subParser("spanGamut")(a, p, h) + "</td>\n"));
                c.push(u)
            }
            return function (g, A) {
        ...
        return g = (g = (g = (g = h.converter._dispatch("tables.before", g, p, h)).replace(/\\(\|)/g, m.helper.escapeCharactersCallback)).replace(/^ {0,3}\|?.+\|.+\n {0,3}\|?[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*:?[ \t]*(?:[-=]){2,}[\s\S]+?(?:\n\n|\xa80)/gm, A)).replace(/^ {0,3}\|.+\|[ \t]*\n {0,3}\|[ \t]*:?[ \t]*(?:[-=]){2,}[ \t]*:?[ \t]*\|[ \t]*\n( {0,3}\|.+\|[ \t]*\n)*(?:\n|\xa80)/gm, A), g = h.converter._dispatch("tables.after", g, p, h)
    ...
    g.innerHTML = 'body { padding: 20px; font-family:  "Helvetica Neue", Helvetica, Arial, sans-serif;} blockquote { padding: 0 1em; color: #6a737d; border-left: 0.25em solid #dfe2e5;} code { padding: 0.2em 0.4em; background: rgba(27,31,35,0.05); border-radius: 3px;} pre > code { background: none } pre { padding: 16px; overflow: auto; line-height: 1.45; background-color: #f6f8fa; border-radius: 3px; } table { border-collapse: collapse; } td, th {  border: 1px solid #ddd; padding: 10px 13px; } ', document.head.prepend(g);
